...
variable "required_cpus" {
  ...
  default     = 16384 # 1024 is the minimum recommended for running Ollama models, works well with 2048
}
variable "required_memory" {
  type        = number
  description = "The required memory for this service"
  default     = 32768 # 4096 is the minimum recommended for running Ollama models, works well with 6144
}
...
variable "ollama_service_version" {
  type        = string
